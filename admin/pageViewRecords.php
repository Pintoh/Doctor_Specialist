				...
				<table class="table">
					...
					<tr>
						<td align="center">
							...
							<?php
								$arrFields = array('', 'patients', 'patient_visits', 'disease_symptoms', 'medical_records');
								$arrFieldCaptions = array('All tables', 'Patients', 'Patient visits', 'Disease symptoms', 'Medical Records');
