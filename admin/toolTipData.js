...
patient_visits_addTip=["",spacer+"This option allows all members of the group to add records to the 'Patient visits' table. A member who adds a record to the table becomes the 'owner' of that record."];

patient_visits_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'Patient visits' table."];
patient_visits_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'Patient visits' table."];
patient_visits_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'Patient visits' table."];
patient_visits_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'Patient visits' table."];

patient_visits_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'Patient visits' table."];
patient_visits_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'Patient visits' table."];
patient_visits_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'Patient visits' table."];
patient_visits_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'Patient visits' table, regardless of their owner."];

patient_visits_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'Patient visits' table."];
patient_visits_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'Patient visits' table."];
patient_visits_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'Patient visits' table."];
patient_visits_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'Patient visits' table."];
