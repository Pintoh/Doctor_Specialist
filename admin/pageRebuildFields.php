<?php
	...
	$schema = array(   
		'patients' => array(   
			...
			'state' => array('appgini' => 'VARCHAR(15) '),
			'zip' => array('appgini' => 'CHAR(8) '),
			'home_phone' => array('appgini' => 'VARCHAR(40) '),
			'work_phone' => array('appgini' => 'VARCHAR(40) '),
			...
			'surgical_history' => array('appgini' => 'TEXT '),
			'obstetric_history' => array('appgini' => 'TEXT '),
			'genetic_diseases' => array('appgini' => 'TEXT '),
			'contact_person' => array('appgini' => 'VARCHAR(100) '),
		...
		'patient_visits' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'patient' => array('appgini' => 'INT unsigned '),
			'type_of_visit' => array('appgini' => 'VARCHAR(40) not null default \'Medical examination\' '),
			'prescription' => array('appgini' => 'TEXT '),
			'diagnosis' => array('appgini' => 'TEXT '),
			'comments' => array('appgini' => 'TEXT '),
			'observation_date' => array('appgini' => 'DATE '),
			'observation_time' => array('appgini' => 'TIME ')
		),
		'disease_symptoms' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'disease' => array('appgini' => 'VARCHAR(200) '),
			'symptoms' => array('appgini' => 'TEXT '),
			'reference' => array('appgini' => 'TEXT ')
		),
		'medical_records' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'patient' => array('appgini' => 'INT unsigned '),
			'document' => array('appgini' => 'VARCHAR(40) '),
